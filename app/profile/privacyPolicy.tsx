      ...
      >
        ...
        >
          ...
          <Text style={styles.p}>
            ...
            data, including encrypted transmission, secure storage, and
          ...
          <Text style={styles.p}>
            ...
            usage, improve performance, and personalize your user experience.
            You may disable cookies in your device settings.
          </Text>
          ...
          <Text style={styles.p}>
            ...
            will be notified within the app.
          </Text>
