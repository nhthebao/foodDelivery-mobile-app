            ...
            const res = await fetch(
                "https://api.openai.com/v1/chat/completions",
                {
                    ...
                    headers: {
                        ...
                        Authorization:
                            "Bearer", // ⚠️ thêm key thật vào đây
                    },
                    body: JSON.stringify({
                        model: "gpt-4o-mini",
                    ...
                    {messages.length === 0 && (
                        <View style={s.welcomeContainer}>
                            ...
                            <Text style={s.welcomeText}>
                                Tôi có thể giúp bạn tìm món ăn phù hợp với sở
                                thích và ngân sách của bạn
                            </Text>
