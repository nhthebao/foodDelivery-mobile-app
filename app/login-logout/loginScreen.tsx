    ...
    >
      <View style={styles.container}>
        ...
        <View style={styles.tabs}>
          <TouchableOpacity style={tabStyle("email")} onPress={() => setMethod("email")}>
            <Text style={method === "email" ? styles.tabTextActive : styles.tabTextInactive}>
              Email
            </Text>
          </TouchableOpacity>
          <TouchableOpacity style={tabStyle("phone")} onPress={() => setMethod("phone")}>
            <Text style={method === "phone" ? styles.tabTextActive : styles.tabTextInactive}>
              Phone Number
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.socialWrap}>
          <View style={styles.dividerRow}>
            ...
            <Text style={{ color: "#999", marginHorizontal: 8 }}>Or continue with</Text>
            <View style={styles.divider} />
          </View>

          <View style={styles.socialRow}>
            <TouchableOpacity style={styles.socialBtn}>
              <Image source={{ uri: "https://via.placeholder.com/40?text=G" }} style={styles.socialIcon} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.socialBtn}>
              <Image source={{ uri: "https://via.placeholder.com/40?text=" }} style={styles.socialIcon} />
            </TouchableOpacity>
            <TouchableOpacity style={styles.socialBtn}>
              <Image source={{ uri: "https://via.placeholder.com/40?text=F" }} style={styles.socialIcon} />
            </TouchableOpacity>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("/login-logout/signupScreen")}
        >
...
const styles = StyleSheet.create({
  ...
  dividerRow: { flexDirection: "row", alignItems: "center", justifyContent: "center" },
  divider: { height: 1, backgroundColor: "#eee", flex: 1, marginHorizontal: 10 },
